...
const steps = [
  ...
  },
  {
    ...
    description:
      'Our expert talent strategists leverage advanced matching algorithms and our elite pre-vetted ServiceNow professionals network to identify, validate, and present candidates with verified expertise and exceptional performance records.',
  },
  {
    id: 3,
    ...
    <section className="job-steps">
      <div className="job-steps-container">
        <div className="job-steps-intro">
          ...
          <h2 className="job-steps-title">Your Pathway to Elite ServiceNow Professionals</h2>
          <p className="job-steps-text">
           Our systematic approach transforms your hiring challenges into strategic advantages through precision matching and rapid deployment of elite ServiceNow professionals.
          </p>
          <Link to="/contact" >
            <button className="job-steps-button">Meet your expectations with us</button>
          </Link>
        </div>
